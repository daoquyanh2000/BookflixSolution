...
{
    public abstract class BookflixSolutionWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static BookflixSolutionWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(BookflixSolutionWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<BookflixSolutionDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<BookflixSolutionDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<BookflixSolutionDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<BookflixSolutionDbContext, Task<T>> func)
        {
            T result;
